...
class Layer:
   ...
   def __init__(self,name,board,color=ROOT.kGray+1,nstrips=404,npoints=100):
      ...
      self.histos  = {"Translation": TH1D(self.name+"_Translation", ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "XYrotation":  TH1D(self.name+"_XYrotation",  ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "Pitchscale":  TH1D(self.name+"_Pitchscale",  ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "Parallelism": TH1D(self.name+"_Parallelism", ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "Bowing":      TH1D(self.name+"Bowing",       ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "Zshift":      TH1D(self.name+"_Zshift",      ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "YZrotationY": TH1D(self.name+"_YZrotationY", ";y_{actual}-y_{nominal} [mm];Number of test points",50,-0.1,+0.1),
                      "YZrotationZ": TH1D(self.name+"_YZrotationZ", ";z_{actual}-z_{nominal} [mm];Number of test points",50,-0.1,+0.1)}
      self.offset = -1
      ...
      self.origin()
      self.pattern()
      print "transform() should be called manually"
      #################
   ...
   def __deepcopy__(self, memo):
      ...
      return Layer(copy.deepcopy(self.name, memo))
